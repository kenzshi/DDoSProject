...
NTP - Used for Python time synchronization
Impacket - Used for python packet manipulation (Changing Source IP/ Setting Packet Flags)
scapy - Used for python packet manipulation (Changing Source IP/ Setting Packet Flags)
